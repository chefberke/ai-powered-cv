  ...
  return (
    <div>
      <div className="flex items-center justify-center gap-2">
        <div className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 w-24 h-2 rounded-full"></div>
        <div className="bg-gray-200 w-24 h-2 rounded-full"></div>
        <div className="bg-gray-200 w-24 h-2 rounded-full"></div>
        <div className="bg-gray-200 w-24 h-2 rounded-full"></div>
      </div>
      <div className="mt-3">
